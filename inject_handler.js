...
document.addEventListener("click", function (event) {
    ...
    (async () => {
        ...
        if (event.target.classList.contains("wipeButton")) {
            //Using the unique key identifiers all data is removed from storage
            chrome.storage.local.remove(['dungeonCaptain', 'clashCaptain', 'duelCaptain', 'flaggedCaptains', 'captainLoyalty', 'idleData', 'dataArray', 'offlinePermission', 'oddIdofflineButton_1', 'oddIdofflineButton_2', 'oddIdofflineButton_3', 'oddIdofflineButton_4'], function () {
